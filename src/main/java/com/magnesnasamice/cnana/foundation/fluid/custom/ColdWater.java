package com.magnesnasamice.cnana.foundation.fluid.custom;
...
public abstract class ColdWater extends FlowableFluid {
    public Fluid getFlowing() {
        return ModFluids.FLOWING_COLD_WATER;
    }

    public Fluid getStill() {
        return ModFluids.STILL_COLD_WATER;
    }

    public Item getBucketItem() {
        return ModItems.COLD_WATER_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModFluids.COLD_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends ColdWater {
        public Flowing() {
        }
    ...
    public static class Still extends ColdWater {
        public Still() {
        }
